...
const praediumRouter       = require('./modules/integrations/praedium.router');
...
app.use('/api/v1/workspaces/:workspaceId/integrations/praedium', requireNotTicketsOnly, praediumRouter);
